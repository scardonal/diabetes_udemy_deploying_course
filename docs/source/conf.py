...
# diabetes_readmission documentation build
...
from diabetes_readmission import __version__ as release
...
htmlhelp_basename = "diabetes_readmissiondoc"
...
texinfo_documents = [
    (
        ...
        author,
        "diabetes_readmission",
        "Project diabetes_readmission codebase.",
        "Data-Science",
    )
]
